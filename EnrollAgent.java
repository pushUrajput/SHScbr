...
public class EnrollAgent extends Agent {
	...
	protected void setup() {
		...
		sd.setType("display-enroll");
		sd.setName("Enroll Information");
		dfd.addServices(sd);
		System.out.println("Hello! Enroll-agent "+getAID().getName()+" is ready.");
		try {
	...
	protected void takeDown() {
		...
		System.out.println("Enroll-agent "+getAID().getName()+" terminating.");
	}
	/**
	   Inner class OfferRequestsServer.
	   This is the behaviour used by Enroll-information agents to serve incoming requests 
	   for information from display agents.
	 */
	private class RequestsServer extends CyclicBehaviour {
		private String record, sapid;
		private String fileName="Enroll";
			...
			switch(step){
				case 0:
					...
					try {
						...
						//System.out.println("Enroll Agent Found the following agents:");
				...
				case 2:
					if (msg != null ||msgr != null ) {
						...
						//System.out.println("Request Received at EnrollAgent: "+System.nanoTime());
						if(msg!=null){
							System.out.println("Request Received at EnrollAgent: "+System.nanoTime());
							sapid = msg.getContent();
						}
						if(msgr!=null){
							System.out.println("Recovery Request Received at EnrollAgent: "+System.nanoTime());
						...
						try{
							...
							System.out.println("Request sent to FileReadAgent from EnrollAgent: "+System.nanoTime());
							myAgent.send(cfp);
							...
							System.out.println("Null Enroll Agent");
						}
						step=3;
					}
					else {
				...
				case 3:
					try{
						...
						if(replyFRA != null)
						{
							System.out.println("Response Received at EnrollAgent from FileReadAgent: " +System.nanoTime());
				...
				case 4:
					myAgent.send(reply);
					System.out.println("Response sent from EnrollAgent to DisplayInformationAgent: "+System.nanoTime());
					fileName="Enroll";
					step=0;
					break;
			}
