...
public class FinanceAgent extends Agent {
	...
	protected void setup() {
		...
		sd.setType("display-finance");
		sd.setName("Finance Information");
		dfd.addServices(sd);
		System.out.println("Hello! Finance-agent "+getAID().getName()+" is ready.");
		try {
	...
	protected void takeDown() {
		...
		System.out.println("Finance-agent "+getAID().getName()+" terminating.");
	}
	/**
	...
	private class RequestsServer extends CyclicBehaviour {
		...
		private String fileName="Finance";
			...
			switch(step){
				case 0:
					...
					try {
						...
						//System.out.println("Finance Agent Found the following agents:");
				...
				case 2:
					if (msg != null ||msgr != null ) {
						...
						//System.out.println("Request Received at FinanceAgent: "+System.nanoTime());
						if(msg!=null){
							System.out.println("Request Received at FinanceAgent: "+System.nanoTime());
							sapid = msg.getContent();
						}
						if(msgr!=null){
							System.out.println("Recovery Request Received at FinanceAgent: "+System.nanoTime());
						...
						try{
							...
							System.out.println("Request sent to FileReadAgent from FinanceAgent: "+System.nanoTime());
							myAgent.send(cfp);
							...
							System.out.println("Null Finance Agent");
						}
						step=3;
					}
					else {
				...
				case 4:
					myAgent.send(reply);
					System.out.println("Response sent from FinanceAgent to DisplayInformationAgent: "+System.nanoTime());
					fileName="Finance";
					step=0;
					break;
			}
